...
Shpadoinkle is broken up into several modules that compose together, or can be used seperately.
...
Logical types and structures for common UI components, along with batteries included implimentations.

Lens (https://gitlab.com/fresheyeball/Shpadoinkle/-/tree/master/lens[Gitlab])::
Lens combinators for erognomic composing of heterogenious components, and after-the-fact modification of views.
