...
* {gitlab}/backends/pardiff#shpadoinkle-backend-pardiff[icon:gitlab[] ParDiff] https://shpadoinkle.org/backend-pardiff[Haddock]
* {gitlab}/backends/snabbdom#shpadoinkle-backend-snabbdom[icon:gitlab[] Snabbdom] https://shpadoinkle.org/backend-snabbdom[Haddock]
* {gitlab}/backends/static#shpadoinkle-backend-static[icon:gitlab[] Static] https://shpadoinkle.org/backend-static[Haddock]
