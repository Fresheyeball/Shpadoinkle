...
* {gitlab}/backends/pardiff#shpadoinkle-backend-pardiff[icon:gitlab[] ParDiff]
* {gitlab}/backends/snabbdom#shpadoinkle-backend-snabbdom[icon:gitlab[] Snabbdom]
* {gitlab}/backends/static#shpadoinkle-backend-static[icon:gitlab[] Static]
