[.text-center]
image::etc/logo.png[Eddie is loved forever,150,150]
[.text-center]
🤠 ⟶ 🥔 🤠
...
https://www.youtube.com/watch?v=0CizU8aB3c8[Shpadoinkle] is aprogramming model for user interface development. It supports flexible, simple, declarative code by modeling user interface interactions as Coalgebras. Currently builds and runs with *ghc 8.6.x* and *ghcjs 8.6.x*.
