...
Deps]]
|https://matrix.hackage.haskell.org/#/package/Shpadoinkle-developer-toolse[image:https://matrix.hackage.haskell.org/api/v2/packages/Shpadoinkle-developer-tools/badge[Hackage
CI]]
