...
See an example of this working by examining {gitlab}/snowman/-/blob/master/snowman/template/nix/base.nix#L57[nix/base.nix] in the {gitlab}/snowman[Seed Project]. You can add packages from https://hackage.haskell.org/[Hackage] and standard Haskell toolchain.
